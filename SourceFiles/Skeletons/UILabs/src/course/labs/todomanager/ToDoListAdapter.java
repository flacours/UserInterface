...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final CheckBox checkBox = (CheckBox)itemLayout.findViewById(R.id.statusCheckBox);
        checkBox.setSelected(toDoItem.getStatus() == Status.DONE ? true : false);
        ...
        String dateFormatted = ToDoItem.FORMAT.format(toDoItem.getDate());
